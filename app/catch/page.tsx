...
export default function CatchRoute() {
  ...
  if (error === 'GUEST_CATCH_LIMIT_REACHED') {
    return (
      <div className="w-full h-screen flex items-center justify-center bg-slate-900 p-4">
        <div className="bg-slate-900/95 border border-amber-500/30 rounded-2xl p-6 max-w-md backdrop-blur-xl">
          <h3 className="text-2xl font-serif text-white mb-2">Daily Catch Limit Reached</h3>
          <p className="text-white/70 mb-6">You&apos;ve used all 3 catch actions for today. Sign in to continue throwing and catching bottles!</p>
