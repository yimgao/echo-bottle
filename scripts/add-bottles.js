/**
 * Add seed bottles script (no deletion)
 * 
 * Usage:
 *   node scripts/add-bottles.js
 */
...
async function addBottles() {
  console.log('🌊 Adding seed bottles...\n');
  ...
  try {
    ...
    // Add new seed data
    console.log('🍾 Adding new seed bottles...');
    ...
    for (const bottle of SEED_DATA) {
      await addDoc(poolRef, {
        ...
        senderId: currentUser.uid // Use current user's UID
      });
