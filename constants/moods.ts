import { Frown, Smile, Heart, MessageSquare, type LucideIcon } from 'lucide-react';

export interface Mood {
  id: 'sad' | 'happy' | 'love' | 'talk';
  icon: LucideIcon;
  label: string;
  color: string;
  text: string;
...
export const SYSTEM_BOTTLES: SystemBottle[] = [
